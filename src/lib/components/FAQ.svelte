<script>
	// FAQ Component with 2 Column Layout
	let selectedIndex = 0; // Default first item selected
...
<section class="py-16 lg:py-24 bg-gradient-to-b from-white to-purple-50">
	<div class="container mx-auto px-6 lg:px-12">
		<!-- Section Header -->
		<div class="text-center mb-12 lg:mb-16">
			<h2 class="text-4xl lg:text-5xl font-bold text-purple-700 mb-4">
				Pertanyaan Umum (FAQ)
			</h2>
			<p class="text-xl text-purple-600 font-medium mb-2">
				untuk Sekolah & Yayasan
			</p>
			<p class="text-gray-600 text-lg max-w-3xl mx-auto">
				Temukan jawaban untuk pertanyaan yang sering diajukan seputar program Kodeflow Academy
			</p>
		</div>

		<!-- 2 Column Layout: Questions on Left, Answer on Right -->
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
			<!-- Left Column - Questions List -->
			<div class="">
				{#each faqs as faq, index}
					<button
						on:click={() => selectFAQ(index)}
						class="group w-full text-left hover:bg-white rounded-2xl p-3  hover:shadow-lg transition-all duration-300  {selectedIndex === index ? 'border-purple-400 bg-purple-50' : 'border-transparent hover:border-purple-200'}"
					>
					
							
							<!-- Question Text -->
							<h3 class="text-base lg:text-lg font-bold leading-relaxed transition-colors duration-300 {selectedIndex === index ? 'text-purple-700' : 'text-gray-900 group-hover:text-purple-600'}">
								{faq.question}
							</h3>
					</button>
				{/each}
			...
			<div class="lg:sticky lg:top-8 h-fit">
				<div class="bg-gradient-to-br from-purple-600 to-purple-800 rounded-3xl p-8 lg:p-10 shadow-2xl min-h-[400px] flex flex-col">
					<!-- Selected Question Title -->
					<div class="mb-6">

						<h3 class="text-2xl lg:text-3xl font-bold text-white leading-tight mb-6">
					...
					<!-- Answer Content -->
					<div class="flex-1">
						<p class="text-purple-50 text-lg leading-relaxed">
		...
		<!-- CTA Section -->
		<div class="mt-16 text-center bg-gradient-to-br from-purple-600 to-purple-800 rounded-3xl p-8 lg:p-12 shadow-2xl">
			<h3 class="text-2xl lg:text-3xl font-bold text-white mb-4">
				Masih Ada Pertanyaan?
			</h3>
			<p class="text-purple-100 mb-6 max-w-2xl mx-auto">
				Tim kami siap membantu Anda. Hubungi kami untuk konsultasi gratis dan demo program.
			</p>
			<div class="flex flex-col sm:flex-row gap-4 justify-center">
				<a href="mailto:info@deeppink-cormorant-883009.hostingersite.com" 
					class="group bg-lime-400 hover:bg-lime-500 text-gray-900 font-semibold px-8 py-4 rounded-full transition-all duration-300 hover:shadow-lg inline-flex items-center justify-center gap-3">
					<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
					</svg>
					<span>Kirim Email</span>
				</a>
				<a href="https://wa.me/6285733235489" target="_blank" rel="noopener noreferrer"
					class="group bg-white hover:bg-gray-50 text-purple-700 font-semibold px-8 py-4 rounded-full transition-all duration-300 hover:shadow-lg inline-flex items-center justify-center gap-3">
