<script>
  ...
  import { Gamepad2, Zap, Globe, Code } from 'lucide-svelte';
  import construct3Img from '$lib/assets/images/materi/c3.svg';
  ...
  const features = [{
      ...
      description:
        'Buat game 2D berkualitas tinggi dengan visual yang memukau.',
  ...
  const projects = [{
      ...
      description:
        'Game platformer klasik dengan player movement, enemies, dan collectibles.',
      features: [
        'Platform physics',
        'Jump & movement',
        'Enemy AI',
    ...
    },
    {
      title: 'Tower Defense',
      description:
        'Game strategi tower defense dengan pathfinding dan upgrade system.',
      features: [
        'Tower placement',
        'Enemy pathfinding',
        'Upgrade system',
  ...
  const willLearn = ['Dasar-dasar game design dan game mechanics',
      ...
      <div class="space-y-6 lg:space-y-8">
        <ScrollReveal animation="fade-up">
          ...
          <h1 class="text-4xl lg:text-6xl font-bold text-white leading-tight">
            Belajar Membuat Game 2D Dengan Construct 3
          </h1>
          <p class="text-xl lg:text-2xl text-white/90 leading-relaxed">
            Game engine <span class="font-bold">visual drag & drop</span> untuk membuat game 2D profesional. Export ke berbagai platform tanpa coding kompleks!
          </p>
        </ScrollReveal>
        ...
        <ScrollReveal animation="fade-up" delay={200}>
          <a
            href="https://wa.me/6285733235489?text=Halo%20Kodeflow%2C%20saya%20tertarik%20dengan%20program%20Construct 3"
            target="_blank"
      ...
      <ScrollReveal animation="fade-left" delay={200}>
        <div class="space-y-6">
          <h2 class="text-3xl lg:text-4xl font-bold text-gray-900">
            Kenapa Harus Construct 3?
          </h2>

          <div class="space-y-4 text-gray-700 leading-relaxed">
            <p>
              Construct 3 adalah <span class="font-bold text-primary-600">game engine visual</span> yang memungkinkan kamu membuat game 2D berkualitas tinggi dengan sistem drag & drop dan event-based logic yang mudah dipahami.
            </p>
            <p>
              Cocok untuk <span class="font-bold text-primary-600">SD sampai SMA</span> karena bisa mulai tanpa coding, tapi juga bisa belajar JavaScript untuk fitur advanced.
            </p>
          </div>

          <a
            href="https://wa.me/6285733235489?text=Halo%20Kodeflow%2C%20saya%20ingin%20jadwalkan%20seminar%20gratis%20Construct 3"
            target="_blank"
            rel="noopener noreferrer"
    ...
    <ScrollReveal animation="zoom">
      <div class="text-center max-w-3xl mx-auto text-white">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="https://wa.me/6285733235489?text=Halo%20Kodeflow%2C%20saya%20ingin%20daftar%20kelas%20Construct 3"
            target="_blank"
            rel="noopener noreferrer"
