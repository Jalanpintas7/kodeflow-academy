...
function _page($$renderer) {
  ...
  const features = [
    ...
    },
    {
      icon: Zap,
      title: "Cepat & Mudah",
      description: "Drag & drop untuk membuat wireframe dan mockup dalam hitungan menit.",
      color: "bg-primary-500"
    },
    {
      icon: Users,
  ...
  const projects = [
    {
      ...
      description: "Prototype aplikasi toko online dengan product listing dan checkout flow.",
      features: [
        "Product catalog",
        "Shopping cart",
        "Checkout flow",
    ...
    },
    {
      ...
      description: "Design dan prototype social media app dengan feed dan interactions.",
      features: [
        "News feed",
        "Post interactions",
        "User profiles",
    ...
    },
    {
      ...
      description: "Prototype app delivery makanan dengan restaurant browse dan order.",
      features: [
        "Restaurant listing",
        "Menu & cart",
        "Order tracking",
    ...
    },
    {
      ...
      description: "Design learning app dengan course catalog, video player, dan progress tracking.",
      features: [
        "Course library",
        "Video player",
        "Progress tracker",
  ...
  const willLearn = [
    "Dasar-dasar UI/UX design dan user-centered design",
  ...
  head("xwqxx1", $$renderer, ($$renderer2) => {
  ...
  ScrollReveal($$renderer, {
    animation: "fade-up",
    children: ($$renderer2) => {
      $$renderer2.push(`<div class="inline-block bg-white/20 backdrop-blur-md border border-white/30 px-4 py-2 rounded-full mb-4"><span class="text-white font-semibold text-sm">16-18 Tahun - SMA</span></div> <h1 class="text-4xl lg:text-6xl font-bold text-white leading-tight">Belajar UI/UX Prototyping Dengan Marvel App</h1> <p class="text-xl lg:text-2xl text-white/90 leading-relaxed">Platform <span class="font-bold">prototyping cepat</span> untuk membuat wireframe dan prototype interaktif. Validasi ide app-mu sebelum development dengan user testing!</p>`);
    }
  });
  $$renderer.push(`<!----> `);
  ScrollReveal($$renderer, {
    ...
    delay: 200,
    children: ($$renderer2) => {
      $$renderer2.push(`<a href="https://wa.me/6285733235489?text=Halo%20Kodeflow%2C%20saya%20tertarik%20dengan%20program%20Marvel App" target="_blank" rel="noopener noreferrer" class="inline-flex bg-secondary-500 hover:bg-secondary-400 text-primary-600 font-bold px-8 py-4 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-2xl items-center gap-2"><span>Hubungi Kami</span> <span>→</span></a>`);
    }
  });
  $$renderer.push(`<!----></div> `);
  ScrollReveal($$renderer, {
    ...
    delay: 200,
    children: ($$renderer2) => {
      $$renderer2.push(`<div class="relative"><div class="absolute inset-0 bg-white/20 rounded-3xl blur-2xl"></div> <div class="relative bg-white/10 backdrop-blur-md border border-white/30 rounded-3xl p-6 shadow-2xl"><img${attr("src", marvelImg)} alt="Marvel App Platform" class="w-full h-auto rounded-2xl"/></div></div>`);
    }
  });
  ...
  ScrollReveal($$renderer, {
    animation: "fade-right",
    children: ($$renderer2) => {
      $$renderer2.push(`<div class="relative"><div class="absolute inset-0 bg-primary-500 rounded-3xl opacity-20 blur-2xl"></div> <div class="relative bg-primary-50 rounded-3xl p-6 lg:p-8 border border-primary-200"><img${attr("src", marvelImg)} alt="Marvel App Platform" class="w-full h-auto rounded-2xl shadow-lg"/></div></div>`);
    }
  });
  $$renderer.push(`<!----> `);
  ScrollReveal($$renderer, {
    ...
    delay: 200,
    children: ($$renderer2) => {
      $$renderer2.push(`<div class="space-y-6"><h2 class="text-3xl lg:text-4xl font-bold text-gray-900">Kenapa Harus Marvel App?</h2> <div class="space-y-4 text-gray-700 leading-relaxed"><p>Marvel App adalah <span class="font-bold text-primary-600">prototyping tool</span> yang memungkinkan kamu membuat wireframe hingga prototype interaktif dengan cepat, lalu test langsung ke user untuk feedback.</p> <p>Cocok untuk <span class="font-bold text-primary-600">SMP &amp; SMA</span> yang ingin belajar UI/UX design thinking dan user testing dengan tools yang simpel dan powerful.</p></div> <a href="https://wa.me/6285733235489?text=Halo%20Kodeflow%2C%20saya%20ingin%20jadwalkan%20seminar%20gratis%20Marvel App" target="_blank" rel="noopener noreferrer" class="inline-flex bg-secondary-500 hover:bg-secondary-400 text-primary-600 font-bold px-8 py-4 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-xl">Jadwalkan Seminar Gratis</a></div>`);
    }
  });
  ...
  for (let index = 0, $$length = each_array.length; index < $$length; index++) {
    ...
    ScrollReveal($$renderer, {
      ...
      delay: index * 100,
      children: ($$renderer2) => {
        $$renderer2.push(`<div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 group"><div${attr_class(`w-16 h-16 ${stringify(feature.color)} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`, "svelte-xwqxx1")}><!---->`);
  ...
  ScrollReveal($$renderer, {
    ...
    children: ($$renderer2) => {
      ...
      $$renderer2.push(`<!--]--></ul> <div class="mt-6 pt-6 border-t border-primary-200"><a href="https://wa.me/6285733235489?text=Halo%20Kodeflow%2C%20saya%20ingin%20jadwalkan%20seminar%20gratis%20Marvel App" target="_blank" rel="noopener noreferrer" class="block text-center bg-secondary-500 hover:bg-secondary-400 text-primary-600 font-semibold px-6 py-3 rounded-full transition-all duration-300 hover:scale-105 text-sm">Jadwalkan Seminar Gratis</a></div></div>`);
    }
  });
    ...
    ScrollReveal($$renderer, {
      ...
      children: ($$renderer2) => {
        ...
        if (openAccordion === index) {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<div class="px-6 lg:px-8 pb-6 lg:pb-8 pt-0 border-t border-gray-100 animate-accordion-down svelte-xwqxx1"><ul class="grid md:grid-cols-2 gap-3 mt-4"><!--[-->`);
